  ...
  return (
    <section className="max-w-full mx-auto px-6 py-16">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        {/* Left */}
        <div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight font-lexend mb-6">
            List your Property
            <br />
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-2xl text-lg transition-colors font-lexend shadow-sm">
              Learn More
            </button>
          </div>
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
            {stats.map(s => (
              <div key={s.label} className={`border ${s.color} rounded-xl p-6 text-center bg-white/50 backdrop-blur-sm`}>
                <p className={`text-3xl font-extrabold font-lexend mb-1 ${s.textColor ?? 'text-blue-600'}`}>{s.value}</p>
        ...
        <div className="relative w-full h-[420px] md:h-[520px] rounded-[48px] overflow-hidden shadow-sm ring-1 ring-gray-200">
          <Image
            src="/placeholder-listing.jpg" // TODO: replace with real marketing image
